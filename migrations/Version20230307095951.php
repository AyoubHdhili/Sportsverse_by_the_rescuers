 ...
 */
final class Version20230307095951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, certification VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, tarif DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, duree_experience INT NOT NULL, level VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_B66FFE929D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
